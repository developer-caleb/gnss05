...
class BluetoothListRecyclerViewAdapter internal constructor(context: Context?, data: ArrayList<Array<String>>) :
    RecyclerView.Adapter<BluetoothListRecyclerViewAdapter.ViewHolder>() {
