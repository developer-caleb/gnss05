...
class WifiListRecyclerViewAdapter internal constructor(context: Context?, data: ArrayList<Array<String>>) :
    RecyclerView.Adapter<WifiListRecyclerViewAdapter.ViewHolder>() {
