...
class MainAdapterViewpager: PagerAdapter, MainpageRecyclerViewAdapter.RecyclerItemClickListener {
    ...
    fun initDefault(){
        ...
        data1.add(MainIcons(R.drawable.ic_1_0_connect_device_off, "장비연결", ConnectEquipmentActivity::class.java))
        data1.add(MainIcons(R.drawable.ic_1_1_move_country_off, "이동국", MobileStationActivity::class.java))
        data1.add(MainIcons(R.drawable.ic_1_2_reference_country_off, "기준국", ReferenceCountryActivity::class.java))
        data1.add(MainIcons(R.drawable.ic_1_3_stop_survey_off, "정지측량", StopSurveyActivity::class.java))
